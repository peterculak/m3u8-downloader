# NewPipeExtractor uses Mozilla Rhino for JavaScript evaluation (YouTube cipher decryption)
...
# Rhino references JDK-only classes that don't exist on Android — suppress R8 warnings.
# These rules are generated automatically by the Android Gradle plugin (missing_rules.txt).
